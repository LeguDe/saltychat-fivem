const messageType = Object.freeze({ "display": 0, "pluginState": 1, "setRange": 2, "setSoundState": 3, "setRadioRange": 4, "setRadioState": 5, "setPosition": 6 })
...
$(function(){
    window.addEventListener("message", function(event) {
		switch (event.data.type) {
			...
			case messageType.setRadioRange: {
